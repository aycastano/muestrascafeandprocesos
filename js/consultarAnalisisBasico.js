...
const analisisbasico = document.getElementById('analisisbasico');
analisisbasico.addEventListener("click",async e=>{
    e.preventDefault();
    //location.reload();
});
        ...
        // $(document).ready(function() {   
            dataTable=$('#tabla_analisis_basicos').DataTable({ 
                columnDefs:[{
                    "defaultContent":"*",
                    "targets":"_all"
                         }],       
